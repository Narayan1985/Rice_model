...
importance[is.na(importance)] <- 0  # Handle NA values
importance <- importance / sum(importance)  # Normalize importance values
importance_df <- data.frame(Feature = names(importance), Importance = importance)
importance_df <- importance_df[order(importance_df$Importance, decreasing = TRUE), ]
importance_df <- importance_df[!importance_df$Feature %in% c("ID", "SeasonB", "site1_Huila_Campoalegre","Site2_Huila_Agrado","Site3_Huila_Campoalegre","Site4_Huila_Villavieja","Site5_Huila_Villavieja",
                                                             "Site6_Huila_Palermo","Site7_Huila_Campoalegre","Site8_Huila_Baraya","Site9_Huila_Neiva","Site10_Huila_Villavieja","Site11_Tolima_Ibague", 
                                                             "Site12_Tolima_Coello","Site13_Tolima_Espinal","Site14_Tolima_Lerida","Site15_Tolima_Melgar","Site16_Tolima_Purificacion","Site17_Tolima_Prado",
                                                             "Site18_Tolima_Guamo","Site19_Tolima_Ambalema","Site20_Tolima_Coyaima","Site21_Tolima_Flandes","Site22_Tolima_Sanluis","Site23_Tolima_Piedras",
                                                             "Site24_Tolima_Lerida","Site25_Tolima_Armero","Site26_Tolima_Honda"), ]
print(importance_df)
